 ...
 **/
class CompliantHelio : public Controller {
public:
  /**
  ...
  **/
  CompliantHelio(float max_f = 0, float min_f = 0, float max_g = 0, float min_g = 0, float etta = 0
...
inline ControllerFactory::Builder make_CompliantHelio_builder() {

  auto fn = [](std::vector<float> params) -> Controller * {
    if (params.size() < 1)
      return nullptr; // not enough parameters

    return new CompliantHelio(params[0], params[1], params[2], params[3],
