#ifndef COMP_HELIO_ADAPT_H
#define COMP_HELIO_ADAPT_H
 ...
 **/
class CompliantHelioAdapt : public Controller {
public:
  /**
  ...
  **/
  CompliantHelioAdapt(float kp = 0, float learn_rate = 0, float learn_rate_h = 0, 
...
inline ControllerFactory::Builder make_CompliantHelioAdapt_builder() {

  auto fn = [](std::vector<float> params) -> Controller * {
    if (params.size() < 1)
      return nullptr; // not enough parameters

    return new CompliantHelioAdapt(params[0], params[1], params[2], params[3],
