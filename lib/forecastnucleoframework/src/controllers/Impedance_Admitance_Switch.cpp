    ...
    if(switch_method == 0 || switch_method == 1){
        ...
        if(flag_impedance_admitance == 1){
            ...
            *(hw->vel_comp_value) = VC_gain*( compensate_2  + compensate_1);
            ...
            out = lowPass->process(control_output_no_filter, hw->get_dt());
        ...
        if(switch_method == 2){
            ...
            if(1){
                ...
                *(hw->vel_comp_value) = VC_gain*( compensate_2  + compensate_1);
                ...
                out_imp = lowPass->process(control_output_no_filter, hw->get_dt());
            ...
            if(1){
                ...
                out_adm = Kp_pos*err_adm + Kd_pos*derr_adm + Ki_pos*ierr_adm;
            }
         ...
         /* POSITION LOOP */
                tau_ref = /*k_des*ref[0] - */ - Kdes*((theta - theta_eq) - ref[0] - switch4_new_theta_ref) -  Ddes*dtheta - Ides*ddtheta;
